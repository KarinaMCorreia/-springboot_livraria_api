...
class LivroControllerTest {
	...
	void deveriaCadastrarLivroComDadosCompletos() throws Exception {
		...
		String jsonLivro = "{\"titulo\":\"Livro Generico\",\"dataLancamento\":\"2020-01-01\",\"numeroDePaginas\":100,\"autor_id\":"
				+ id + "}";

		String jsonLivroRetornado = "{\"titulo\":\"Livro Generico\"," + "\"dataLancamento\":\"2020-01-01\","
				+ "\"numeroDePaginas\":100," + "\"autor\": {\"id\": " + id + "}}";
